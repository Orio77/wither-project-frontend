...
export function Header() {
	return (
		<header className="sticky top-0 w-full bg-gradient-to-b from-accent/95 via-primary/90 to-transparent backdrop-blur-sm py-4 md:py-6 mb-8 z-50 transition-all duration-200">
